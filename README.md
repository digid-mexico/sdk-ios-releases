...
Si tu tema tiene una combinación de bajo contraste, además del ajuste automático verás un aviso en consola al inicializar el SDK, indicando qué colores conviene revisar.
